...
import abundancia from "./abundancia.png";
import limpsal from "./limpsal.png";
import sahumos from "./sahumos.png";

const cardsData = [
  {
    id: 1,
    title: "Ritual para la abundancia",
    imageSrc: abundancia, // Aquí puedes cambiar la URL de la imagen
    description:
      "Este ritual se hace a la primera hora del día, ni bien te levantás. Llená 3/4 partes de un vaso con agua y diluir en él una cucharada de azúcar. Luego ponerlo al lado de una vela dorada (o amarilla). Luego, en un papel de color amarillo escribimos todo lo que deseamos lograr en el terreno económico y detallamos todos esos proyectos que tenemos en mente y con los que deseamos ganar dinero. Cuando estés seguro de haber dejado todo lo que deseas por escrito, doblá el papel en cuatro partes y colocalo debajo del vaso. En ese momento hay que poner una cucharada más de azúcar al agua y prender la vela. Cerrá los ojos y visualizate logrando todo lo que escribiste sin ningún tipo de esfuerzo. Tomate el tiempo que necesites y luego, dí en voz alta: Lo lograré. 'El dinero y la abundancia vendrán a mí. Gracias, gracias, gracias.' ​Repetí el ritual tres días seguidos. Cuando se apaga la tercera vela, se desecha el agua con azúcar y se quema el papel.",
  },
  {
    id: 2,
