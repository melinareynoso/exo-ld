  ...
  return (
    <section id="Especialistas" className="esp-container">
      ...
      <h3 id="subtitle">
        ...
        preocupaciones. Nuestra intuición y habilidades psíquicas nos permiten
        interpretar las cartas de manera profunda y precisa, proporcionando una
        visión detallada de los aspectos emocionales, profesionales, financieros
        y personales de tu vida.
      </h3>
